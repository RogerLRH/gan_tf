...
class GANClassifier(object):
    ...
    def train(self, data_file, data_loader=GANClassloader, sample_dir="samples", ckpt_dir='checkpoints', checkpoint=None, epoches=10000, batch_size=128, D_k=1, G_k=1, C_real_k=2, C_fake_k=1):
